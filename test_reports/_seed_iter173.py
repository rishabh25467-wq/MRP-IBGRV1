"""Seed synthetic super_admin session for iteration_172 Production dropdown test."""
...
USER_ID = "iter173-tid:iter173-super-admin"
tid, oid = USER_ID.split(":", 1)
EMAIL = "iter173-header@example.com"
...
with open("/tmp/iter173_session.json", "w") as f:
