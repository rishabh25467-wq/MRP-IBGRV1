"""Seed synthetic super_admin session for iteration_170 header overlap test."""
...
USER_ID = "iter170-tid:iter170-super-admin"
tid, oid = USER_ID.split(":", 1)
EMAIL = "iter170-header@example.com"
...
with open("/tmp/iter170_session.json", "w") as f:
