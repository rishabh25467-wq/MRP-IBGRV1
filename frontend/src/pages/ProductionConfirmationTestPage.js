...
export default function ProductionConfirmationTestPage() {
  ...
  return (
    <div className="print:hidden h-screen flex flex-col overflow-hidden bg-[#F2F4F7] text-[#1D2939]">
      ...
      <header className="min-h-16 bg-[#7C2D12] shadow-[0_1px_3px_0_rgba(16,24,40,0.15)] flex items-center justify-between px-3 sm:px-5 shrink-0 z-10 gap-2 sm:gap-4">
        ...
        {loading ? (
          ...
          <div className="border border-[#D0D5DD] rounded-sm overflow-auto bg-white">
            <table className="w-full text-[13px] border-collapse" data-testid="production-lots-table">
              <thead>
                <tr>
                  {["Lot ID", "Output Product", "Site", "End Date", "Status", "Reporting Point", "Planned", "Confirmed So Far", "Open", "Awaiting Prev Step", "UOM", "Finished", "Created By", "Production Model", "Stock", "Last Confirmation", ""].map((h) => (
